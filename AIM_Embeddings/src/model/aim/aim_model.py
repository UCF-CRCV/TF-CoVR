...
class ViT_CLIP(nn.Module):
    ...
    def __init__(self, input_resolution: int, num_frames: int, patch_size: int, width: int, layers: int, heads: int, drop_path_rate, num_tadapter=1, adapter_scale=0.5, pretrained=None, num_classes=297):
        super().__init__()
        ...
        self.fc_cls = nn.Linear(768, self.num_classes)
